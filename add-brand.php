...
<!--  Author Name: Trung Kiên. 
 for any PHP, Codeignitor, Laravel OR Python work contact me at mayuri.infospace@gmail.com  
 Visit website : www.NOWDEMY.com -->   
 
        <div class="page-wrapper">
            
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Add Manufacturer Management</h3> </div>
                ...
                <div class="row">
                    <div class="col-lg-8" style="    margin-left: 10%;">
                                ...
                                <div class="input-states">
                                   ...
                                   <input type="hidden" name="currnt_date" class="form-control">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <label class="col-sm-3 control-label">Nhà phân phối</label>
                                                <div class="col-sm-9">
                        ...
                        <option value="2">Không có sẵn</option>
                                        ...
                                        <button type="submit" name="create" id="createBrandBtn" class="btn btn-primary btn-flat m-b-30 m-t-30">Thêm</button>
                                    </form>
                                </div>
                            </div>
                        </div>
