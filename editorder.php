...
//echo $sql;exit;
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="clientName" name="clientName" placeholder="Tên Khách Hàng" autocomplete="off" value="<?php echo $data[2] ?>" />
        </div> 
        <div class="form-group col-md-12">
           <label class="control-label">Client Số điện thoại</label>
            <input type="text" class="form-control" id="clientContact" name="clientContact" placeholder="Số điện thoại Number" autocomplete="off" value="<?php echo $data[3] ?>" pattern="^[0][1-9]\d{9}$|^[1-9]\d{9}$"/>
      </div>       
        ...
        <table class="table" id="productTable">
          <thead>
            <tr>              
              ...
              <th style="width:15%;">Có sẵn Quantity</th>              
              <th style="width:15%;">Số lương</th>              
          ...
          <div class="form-group col-md-6">
            <label for="subTotal" class="control-label">Tổng tiền</label>
          ...
          <div class="form-group col-md-6">
            <label for="totalAmount" class=" control-label">Tổng tiền sau khi áp thuế</label>
          ...
          <div class="form-group col-md-6">
            <label for="grandTotal" class="control-label">Tổng tiền sau khi giảm giá</label>
          ...
          <div class="form-group col-md-6">
            <label for="vat" class="col-sm-3 control-label gst"><?php if($data[13] == 2) {echo "IGST 18%";} else echo "Thuế 18%"; ?></label>
          ...
          <div class="form-group col-md-6">
            <label for="paid" class="control-label">Tiền phải trả</label>
          ...
          <div class="form-group col-md-6">
            <label for="clientContact" class="control-label">Hình thức thanh toán</label>
          ...
          <div class="form-group col-md-6">
            <label for="clientContact" class="control-label">Tình trạng thanh toán</label>
