        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Cập nhật loại thuốc Management</h3> </div>
                ...
                <div class="row">
                    <div class="col-lg-8" style="    margin-left: 10%;">
                                    ...
                                    <form class="form-horizontal" method="POST"  id="submitBrandForm" action="php_action/editCategories.php?id=<?php echo $_GET['id'];?>"enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                  <input type="text"  class="form-control"id="categoriesName" placeholder="Tên loại thuốc" name="categoriesName"  value="<?php echo $result['categories_name']?>"required="" pattern="^[a-zA-z]+$"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                        ...
                        <option value="1" <?php 
                                                        ...
                                                        ?>>Có sẵn</option>
                                                        <option value="2" <?php if($result['categories_active']=="2"){ echo "selected";}?>>Không có sẵn</option>
                      </select>
