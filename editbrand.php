                ...
                <div class="row">
                    <div class="col-lg-8" style="    margin-left: 10%;">
                      ...
                      <select class="form-control" id="brandStatus" name="brandStatus">
                                                        ...
                                                        ?>>Có sẵn</option>
                                                        <option value="2" <?php if($result['brand_active']=="2"){ echo "selected";}?>>Không có sẵn</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <button type="submit" name="create" id="createBrandBtn" class="btn btn-primary btn-flat m-b-30 m-t-30">Cập nhật</button>
                                    </form>
                                </div>
                            </div>
                        </div>
