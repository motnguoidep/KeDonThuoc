...
<div class="page-wrapper">
  ...
  <div class="row page-titles">
    <!-- <div class="col-md-5 align-self-center">
      <h3 class="text-primary">Quản lý hóa đơn</h3>
    </div> -->
    <div class="col-md-7 align-self-center">
      <ol class="breadcrumb">
      <h3 class="text-primary" style="font-size: 30px">THÊM HÓA ĐƠN</h3>
      ...
      <div class="col-lg-11" style="    margin-left: 5%;">
        <div class="card">
          ...
          <div class="card-body">
            <div class="input-states">
              <form class="form-horizontal" method="POST" id="createOrderForm" action="php_action/order.php"
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-4">
                      ...
                      <input type="text" class="form-control" placeholder="Invoice Number"
                        value="<?php echo $stall_no; ?>" autocomplete="off" name="uno" required />
                    </div>


                    <label class="col-sm-2 control-label">Ngày lập hóa đơn</label>

                    <div class="col-sm-4">
                      <input type="date" class="form-control" value="<?php echo date('Y-m-d'); ?>" id="orderDate"
                ...
                <div class="form-group">
                  <div class="row">
                    ...
                    <label class="col-sm-2 control-label">Số điện thoại khách hàng</label>
                    <div class="col-sm-4">
                      <input type="text" class="form-control" id="clientContact" name="clientContact"
                        placeholder="Số điện thoại khách hàng" autocomplete="off" required />
                    </div>
                ...
                <table class="table" id="productTable">
                  <thead>
                    <tr>
                      <th style="width:40%; padding-left:0px;">Thuốc</th>
                      <th style="width:20%;padding-left:20px;">Giá</th>
                      <!-- <th style="width:0%;padding-left:20px;"></th> -->
                      <th style="width:15%;padding-left:10px;">Số lương</th>
                      <th style="width:25%;padding-left:20px;">Tổng số</th>
                  ...
                  <p id="available_quantity<?php echo $x; ?>"></p>
                        ...
                        <td>
                          ...
                          <button type="button" class="btn btn-primary btn-flat " onclick="addRow()" id="addRowBtn"
                            data-loading-text="Loading..."> <i class="fa fa-plus"></i></button>
              ...
              <td>
                ...
                <button type="button" class="btn btn-danger  removeProductRowBtn" type="button" id="removeProductRowBtn"
                  onclick="removeProductRow(<?php echo $x; ?>)"><i class="fa fa-trash"></i></button>
            </div>
            </td>
          ...
          <!-- <div class="form-group mt-4">
            <div class="row">
              <label for="vat" class="col-sm-2 control-label gst">Thuế 18%</label>
              <div class="col-sm-4">
                <input type="text" class="form-control" id="vat" name="gstn" readonly="true" />
                <input type="hidden" class="form-control" id="vatValue" name="vatValue" />
              </div>

              <label for="totalAmount" class="col-sm-2 control-label">Tổng tiền sau khi áp thuế</label>
              <div class="col-sm-4">
          ...
          <!-- <div class="form-group">
            <div class="row">
              ...
              <label for="grandTotal" class="col-sm-2 control-label">Tổng tiền sau khi giảm giá</label>
              <div class="col-sm-4">
          ...
          <div class="form-group">
            <div class="row">
              <label for="clientContact" class="col-sm-2 control-label">Hình thức thanh toán</label>
              <div class="col-sm-4">
              ...
              <label for="clientContact" class="col-sm-2 control-label">Tình trạng thanh toán</label>
              <div class="col-sm-4">
        ...
        <div class="form-group submitButtonFooter">
          <div class="col-sm-offset-2 col-sm-10">
            <button type="submit" id="createOrderBtn" data-loading-text="Loading..."
              class="btn btn-success btn-flat m-b-30 m-t-30"><i class="glyphicon glyphicon-ok-sign"></i> Thêm</button>

            <button type="reset" class="btn btn-danger btn-flat m-b-30 m-t-30" onclick="resetOrderForm()"><i
                class="glyphicon glyphicon-erase"></i> Quay lại</button>
          </div>
        </div>
  ...
  $(document).ready(function () {
    ...
    if (divRequest == 'add') {
      ...
      $("#createOrderForm").unbind('submit').bind('submit', function () {
        ...
        if (clientContact == "") {
          $("#clientContact").after('<p class="text-danger"> The Phone Number field is required </p>');
        ...
        if (discount == "") {
          $("#discount").after('<p class="text-danger"> The Giảm giá field is required </p>');
